...
# Can we predict whether a car is V or Straight based on other data?
...
mod2 = glm(vs ~ hp, data = df, family = "binomial") # family = "binomial" is the important part
mod2
df$binom.pred <- predict(mod2, type = "response") # memorize type = "response"
...
# 
mod3 = glm(vs ~ hp + wt + factor(cyl), data = mtcars, family = "binomial")
